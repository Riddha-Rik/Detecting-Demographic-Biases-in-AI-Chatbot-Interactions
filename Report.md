...
3. Key Results: Age Bias Detected: The model showed a coefficient of -0.0148 for Age. This proves an inverse relationship: as age increases, encouragement from the AI decreases significantly.
...
4. Conclusion: The project successfully validated the presence of demographic bias in simulated AI career coaching. This highlights the need for Bias Auditing in LLM deployments to ensure equitable career guidance for all age groups and genders.
